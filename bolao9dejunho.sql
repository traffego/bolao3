...
REPLACE INTO `administrador` (`id`, `nome`, `email`, `senha`, `status`, `data_cadastro`, `ultimo_acesso`, `ultimo_login`) VALUES
	(1, 'Administrador', 'admin@bolao.com', '$2a$10$/pFpEVzPqpLUnQqOqO9JJ.ExbamPa7aPRR9KicD7ZMu5sgFl6Xo/y', 'ativo', '2025-05-20 18:08:25', NULL, '2025-06-06 16:36:19');
...
REPLACE INTO `configuracoes` (`id`, `nome_configuracao`, `valor`, `categoria`, `descricao`, `data_criacao`, `data_atualizacao`) VALUES
	...
	(13, 'api_football', '{"api_key":"ad0b29bd4984b69fd16d9680c6d017c1","base_url":"https:\\/\\/v3.football.api-sports.io","last_request":"2025-06-04 17:52:27"}', 'api', 'Configurações da API Football', '2025-05-30 19:38:41', '2025-06-04 17:52:27'),
...
REPLACE INTO `jogador` (`id`, `nome`, `email`, `senha`, `telefone`, `cpf`, `status`, `data_cadastro`, `ultimo_acesso`, `token_recuperacao`, `token_expira`, `saldo`, `pagamento_confirmado`, `txid_pagamento`) VALUES
	(1, 'JONATHAS QUINTANILHA', 'jogador@bolao.com', '$2y$12$5Q4bPMNugRrydUWBjvl5uu7tX83y1NW.PUa.j34zl/fF/p3YG7Joy', '(21) 96738-0813', NULL, 'ativo', '2025-05-24 16:26:20', NULL, NULL, NULL, 0.00, 1, 'BOL001010174924865810f0e279d29cf036'),
